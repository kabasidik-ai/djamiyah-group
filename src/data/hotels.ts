...
export const maisonBlanche: Hotel = {
  ...
  images: {
    ...
    restaurant: '/images/corporate/restaurant-service.webp',
...
export const rama: Hotel = {
  ...
  images: {
    hero: '/images/corporate/hotel-ramakissidougou.webp',
    exterior: '/images/corporate/hotel-ramakissidougou.webp',
    lobby: '/images/logo-djamiyah.svg',
